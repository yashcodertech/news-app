...
const fetchNews = async (query, page) => {
    ...
    // { MY API }
    var url = `https://newsapi.org/v2/everything?q=${query}&from=2023-03-23&sortBy=popularity&pageSize=12&language=en&page=${page}&apiKey=b22119acc3d24bbe952215a0b5ad2e4a`;
